...
const ProductDetails2 = () => {
  ...
  return (
    <View style={styles.productDetails2}>
      ...
      <View style={[styles.productDetails2Child2, styles.wrapperPosition]} />
      <Pressable
      ...
      />
      <Image
        style={[styles.productDetails2Child6, styles.productChildLayout]}
        resizeMode="cover"
        source={require("../assets/ellipse-5.png")}
      />
      <Image
